...
public class MailSender {
	...
	/** 以文本格式发送邮件*/
	private boolean sendTextMail(MailSenderInfo mailInfo) throws Exception {
		// 判断是否需要身份认证
	...
	/** 以HTML格式发送邮件*/
	private boolean sendHtmlMail(MailSenderInfo mailInfo) throws Exception {
		// 判断是否需要身份认证
		MailAuthenticator authenticator = null;
		Properties pro = mailInfo.getProperties();
	...
	public static boolean sendEmail(String SMTP, String PORT, String EMAIL,
		...
		if (TEXT.equals(TYPE))
			...
			throw new Exception("The type is not incorrect !");
	}
	
	/** 发邮件*/
	public static boolean sendEmail(MailSenderInfo mailInfo, String type) throws Exception {
